...
class audio_handler:
    def __init__(self):
        ...
        self.client = ElevenLabs(api_key="sk_6f02318cc721328ad27627034a151e77d4db0fa52dc9a5df")
...
class youtube_integrator:
    ...
    def youtube_uploader(self, file, title):
        ...
        def get_authenticated_service():
            ...
            if not creds or not creds.valid:
                if creds and creds.expired and creds.refresh_token:
                    ...
                    flow = InstalledAppFlow.from_client_secrets_file(
                        "scripts/client_secret_205382003149-fhume0a6fcqfc810pq062a4uuvn91rci.apps.googleusercontent.com.json",
                        SCOPES
                    )
            ...
            # **Here’s the key change**: explicitly use AuthorizedHttp
            http = httplib2.Http()
            authed_http = AuthorizedHttp(creds, http=http)

            # Pass the authed_http instead of credentials=
        ...
        upload_video(file_path=file,
        title=title+self.generate_high_quality_tags(type_="title"),
        description=self.generate_high_quality_tags(type_="description"),
        tags=self.generate_high_quality_tags(type_="tags"),
        category_id="22",
...
# )
# youtube_integrator().youtube_uploader(file="videos/final_output4569.mp4", title="test upload")
